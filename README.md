...
**3:00pm Module 4** | Labor Day | [Navigating the file system + some meta skills (Ilias)][1-1D]  | [JS Control Flow(Ben)][1-4A] |  [DOM Manipulation(Alex)][1-4C]  | [Weekend Lab: JS Racer (Alex) ][1-4E]       
**Training** | Labor Day | [Lab: Command line (Ilias)][1-1E] + Read for Tomorrow | [Lab: Build a website (Ben)][1-2E] + Control Flow reading| [LOTR DOM Manipulation Lab(Alex)][1-4D]  | JS Racer
